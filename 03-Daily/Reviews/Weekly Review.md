...
Use esta nota como ponto de entrada fixo para a revisão da semana.
...
Os dashboards leem humor e energia dos arquivos em `03-Daily/Morning Reviews/` e `03-Daily/Evening Reviews/`. Não registre esses campos no frontmatter da daily note.
