...
for (let i = 0; i < cells.length; i += 7) {
    ...
    for (const day of week) {
        ...
        const dayLabel = journal
            ...
            row += `<td style="width:42px;height:42px;padding:3px;border-radius:8px;background:${color};vertical-align:top;">
                <div style="font-size:0.68em;line-height:1;text-align:right;">${dayLabel}</div>
                <div style="text-align:center;font-size:0.95em;line-height:1.5;margin-top:2px;">${emoji}</div>
            </td>`;
    }
